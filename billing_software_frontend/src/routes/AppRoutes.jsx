...
import HomeBannerList from "../pages/banners/HomeBannerList";
import HomeBannerForm from "../pages/banners/HomeBannerForm";
import CelebrationBannerList from "../pages/celebration/CelebrationBannerList";
import CelebrationBannerForm from "../pages/celebration/CelebrationBannerForm";
...
<Route path="/forgot-password" element={<ForgotPassword />} />
        ...
        >
          ...
          <Route element={<ProtectedRoute allowedRoles={["admin"]} />}>
            ...
            <Route path="/home-banners/add" element={<HomeBannerForm />} />
            <Route path="/home-banners/edit/:id" element={<HomeBannerForm />} />
            <Route path="/celebration-banner" element={<CelebrationBannerList />} />
            <Route path="/celebration-banner/add" element={<CelebrationBannerForm />} />
            <Route path="/celebration-banner/edit/:id" element={<CelebrationBannerForm />} />
