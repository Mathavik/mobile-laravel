    ...
    try {
      ...
      if (res.data.status) {
        ...
        setForm({
          ...
          view_count: p.view_count ? String(p.view_count) : "0",
          is_deleted: p.is_deleted ? String(p.is_deleted) : "0"
        });

        const seed = Array.isArray(p.keywords_list)
          ? p.keywords_list
          : p.keywords ? String(p.keywords).split(",").map(k => k.trim().toLowerCase()).filter(Boolean) : [];
        setKeywordTags([...new Set(seed)]);
  ...
  const handleUpdate = async () => {
    ...
    try {
      const res = await api.post("/product/update", {
        ...
        is_deleted: Number(form.is_deleted || 0)
      });
      if (res.data.status) {
        show("success", "Product Updated!", `"${form.name}" saved successfully.`);
        setTimeout(() => navigate("/products"), 1800);
  ...
  {fetching
    ...
    : <div className="ep-select-wrap ep-input-wrap">
        ...
        <span className="ep-select-arrow">▾</span>
            ...
            <div className="ep-grid-2">
              <div className="ep-field">
                <label className="ep-label">Image URL</label>
                <div className="ep-input-wrap">
                  <span className="ep-input-icon">🖼️</span>
                  <input className="ep-input" placeholder="https://example.com/image.jpg"
                    value={form.image}
                    onChange={e => set("image", e.target.value)} />
                </div>
              </div>
              <div className="ep-field">
                <label className="ep-label">Video URL</label>
                <div className="ep-input-wrap">
                  <span className="ep-input-icon">🎬</span>
                  <input className="ep-input" placeholder="https://example.com/video.mp4"
            ...
            <div className="ep-field">
              <label className="ep-label">Gallery Images</label>
              <div className="ep-input-wrap">
                <span className="ep-input-icon">🗂️</span>
                <textarea className="ep-input" style={{ minHeight: "90px", paddingLeft: "42px" }} placeholder="Enter image URLs separated by commas or new lines"
                  value={form.image_gallery_json}
                  onChange={e => set("image_gallery_json", e.target.value)} />
              </div>
            </div>
            ...
            <div className="ep-grid-2">
              <div className="ep-field">
                ...
                <div className="ep-select-wrap ep-input-wrap">
                  <span className="ep-input-icon">✅</span>
                  <select className="ep-select" value={form.active_status} onChange={e => set("active_status", e.target.value)}>
            ...
            <div className="ep-field">
              ...
              <div className="ep-input-wrap">
                <span className="ep-input-icon">✍️</span>
                <textarea className="ep-input" style={{ minHeight: "80px", paddingLeft: "42px" }} placeholder="Short description"
            ...
            <div className="ep-field">
              ...
              <div className="ep-input-wrap">
                <span className="ep-input-icon">📝</span>
                <textarea className="ep-input" style={{ minHeight: "120px", paddingLeft: "42px" }} placeholder="Full description"
            ...
            <div className="ep-field">
              <label className="ep-label">Search Keywords</label>
              <KeywordTagInput
                value={keywordTags}
