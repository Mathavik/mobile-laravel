    ...
    <span className="pf-select-arrow">▾</span>
            ...
            <div className="pf-grid-2">
              <div className="pf-field">
                ...
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">🖼️</span>
                  <input className="pf-input" placeholder="https://example.com/image.jpg"
                    value={form.image}
              ...
              <div className="pf-field">
                ...
                <div className="pf-input-wrap">
                  <span className="pf-input-icon">🎬</span>
                  <input className="pf-input" placeholder="https://example.com/video.mp4"
            ...
            <div className="pf-field">
              ...
              <div className="pf-input-wrap">
                <span className="pf-input-icon">🗂️</span>
                <textarea className="pf-input" style={{ minHeight: "90px", paddingLeft: "42px" }} placeholder="Enter image URLs separated by commas or new lines"
            ...
            <div className="pf-grid-2">
              <div className="pf-field">
                ...
                <div className="pf-select-wrap pf-input-wrap">
                  <span className="pf-input-icon">✅</span>
                  <select className="pf-select" value={form.active_status} onChange={e => set("active_status", e.target.value)}>
            ...
            <div className="pf-field">
              ...
              <div className="pf-input-wrap">
                <span className="pf-input-icon">✍️</span>
                <textarea className="pf-input" style={{ minHeight: "80px", paddingLeft: "42px" }} placeholder="Short description"
            ...
            <div className="pf-field">
              ...
              <div className="pf-input-wrap">
                <span className="pf-input-icon">📝</span>
                <textarea className="pf-input" style={{ minHeight: "120px", paddingLeft: "42px" }} placeholder="Full description"
            ...
            <div className="pf-field">
              <label className="pf-label">Search Keywords</label>
              <KeywordTagInput
                value={keywordTags}
